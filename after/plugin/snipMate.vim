...
" :help snipMate-remap).
ino <silent> <c-e> <c-r>=TriggerSnippet()<cr>
snor <silent> <c-e> <esc>i<right><c-r>=TriggerSnippet()<cr>
ino <silent> <c-y> <c-r>=BackwardsSnippet()<cr>
snor <silent> <c-y> <esc>i<right><c-r>=BackwardsSnippet()<cr>
